...
const unitSize = 25;
let running = false;
// xVelocity = positive => move to right
// xVelocity = negative => move to left
let xVelocity = unitSize;
// yVelocity = positive => move down
// yVelocity = negative => move up
// yVelocity = 0 => stay still
let yVelocity = 0;
let foodX, foodY;
let score = 0;
let snake = [
...
function drawSnake(){
    ...
    snake.forEach(snakePart => {
        ...
        snakePart.strokeStyle = snakeBorder;
